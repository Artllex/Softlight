...
$extensionVersion = (Get-Content firefox/manifest.json -Raw | ConvertFrom-Json).version
Compress-Archive -Path firefox/* -DestinationPath "dist/Softlight-Firefox-Extension-$extensionVersion.zip" -Force
